...
export default function SectionPerformance() {
  return (
    <section className="section grid gap-8 md:grid-cols-2 items-center">
      <div className="card">
        <Image src="/fit-club.jpg" alt="Performance FITSTRATEGY" width={900} height={600} className="rounded-xl" />
        <p className="mt-3 text-muted text-sm">Étude de cas — +35 % de CA en 6 mois.</p>
      </div>
      <div className="card">
